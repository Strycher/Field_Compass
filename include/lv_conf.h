 ...
 * link at all. CUSTOM routes every LVGL allocation to PSRAM instead, which the
 * board has 2MB of and which already holds the LVGL draw buffers. */
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (160 * 1024U)         /**< [bytes] — increased 128→160KB: OOM crash in fcListPickerOpen (#119) */
